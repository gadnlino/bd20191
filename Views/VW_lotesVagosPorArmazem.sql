...
DROP VIEW IF EXISTS VW_lotesVagosPorUnidade;
CREATE VIEW VW_lotesVagosPorUnidade AS select r.idUnidade_PK as 'idUnidade',
    r.idArmazem_PK as 'idArmazem',r.idLote_PK as 'idLote',r.setor,r.posicao from (select l.idLote_PK,a.idArmazem_PK,
